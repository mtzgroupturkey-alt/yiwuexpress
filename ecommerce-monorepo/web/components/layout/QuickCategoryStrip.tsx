...
const DEFAULT_CATEGORIES: Record<string, QuickCategoryItem[]> = {
  ru: [
    { id: 'deals', label: 'Акции и Скидки', icon: '🔥', href: '/products?onSale=true', highlighted: 'deals' },
    { id: 'wholesale', label: 'Прямой Опт', icon: '📦', href: '/wholesale', highlighted: 'wholesale' },
    { id: 'cnc', label: 'Станки с ЧПУ', icon: '⚙️', href: '/products?category=cnc-machinery' },
    { id: 'tools', label: 'Электроинструмент', icon: '🔌', href: '/products?category=power-tools' },
    { id: 'welding', label: 'Сварочное оборудование', icon: '⚡', href: '/products?category=welding-equipment' },
    { id: 'lasers', label: 'Лазерные резаки', icon: '🎯', href: '/products?category=laser-cutters' },
    { id: 'hardware', label: 'Крепеж и Оснастка', icon: '🔩', href: '/products?category=hardware' },
    { id: 'hydraulic', label: 'Гидравлика и Пневматика', icon: '🏗️', href: '/products?category=hydraulic-presses' },
    { id: 'measuring', label: 'Измерительные приборы', icon: '📏', href: '/products?category=measuring-instruments' },
    { id: 'safety', label: 'СИЗ и Безопасность', icon: '🦺', href: '/products?category=safety-gear' },
    { id: 'generators', label: 'Генераторы и Силовые узлы', icon: '🔋', href: '/products?category=generators' },
    { id: 'all', label: 'Все категории', icon: '📂', href: '/products' },
  ],
  en: [
    { id: 'deals', label: 'Flash Deals', icon: '🔥', href: '/products?onSale=true', highlighted: 'deals' },
    { id: 'wholesale', label: 'B2B Wholesale', icon: '📦', href: '/wholesale', highlighted: 'wholesale' },
    { id: 'cnc', label: 'CNC Machinery', icon: '⚙️', href: '/products?category=cnc-machinery' },
    { id: 'tools', label: 'Power Tools', icon: '🔌', href: '/products?category=power-tools' },
    { id: 'welding', label: 'Welding Gear', icon: '⚡', href: '/products?category=welding-equipment' },
    { id: 'lasers', label: 'Laser Cutters', icon: '🎯', href: '/products?category=laser-cutters' },
    { id: 'hardware', label: 'Hardware & Fittings', icon: '🔩', href: '/products?category=hardware' },
    { id: 'hydraulic', label: 'Hydraulics & Presses', icon: '🏗️', href: '/products?category=hydraulic-presses' },
    { id: 'measuring', label: 'Measuring Systems', icon: '📏', href: '/products?category=measuring-instruments' },
    { id: 'safety', label: 'Safety & PPE', icon: '🦺', href: '/products?category=safety-gear' },
    { id: 'generators', label: 'Generators & Power', icon: '🔋', href: '/products?category=generators' },
    { id: 'all', label: 'All Categories', icon: '📂', href: '/products' },
  ],
  zh: [
    { id: 'deals', label: '限时秒杀特惠', icon: '🔥', href: '/products?onSale=true', highlighted: 'deals' },
    { id: 'wholesale', label: '工厂大宗集采', icon: '📦', href: '/wholesale', highlighted: 'wholesale' },
    { id: 'cnc', label: '高精数控机床', icon: '⚙️', href: '/products?category=cnc-machinery' },
    { id: 'tools', label: '专业电动工具', icon: '🔌', href: '/products?category=power-tools' },
    { id: 'welding', label: '工业焊接装备', icon: '⚡', href: '/products?category=welding-equipment' },
    { id: 'lasers', label: '光纤激光切割', icon: '🎯', href: '/products?category=laser-cutters' },
    { id: 'hardware', label: '五金紧固配件', icon: '🔩', href: '/products?category=hardware' },
    { id: 'hydraulic', label: '液压与气动装备', icon: '🏗️', href: '/products?category=hydraulic-presses' },
    { id: 'measuring', label: '精密量仪测绘', icon: '📏', href: '/products?category=measuring-instruments' },
    { id: 'safety', label: '劳保与安全防护', icon: '🦺', href: '/products?category=safety-gear' },
    { id: 'generators', label: '发电机与动力机组', icon: '🔋', href: '/products?category=generators' },
    { id: 'all', label: '全部分类', icon: '📂', href: '/products' },
  ]
}
