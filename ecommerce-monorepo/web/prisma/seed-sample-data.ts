  ...
  products.push(
    await prisma.product.upsert({
      ...
      create: {
        ...
        thumbnail: '/images/products/cable.jpg',
        stock: 500,
        weightKg: 0.1,
        countryOfOrigin: 'China',
        isActive: true,
  ...
  products.push(
    await prisma.product.upsert({
      ...
      create: {
        ...
        costPrice: 12.00,
        images: ['/images/products/plant-pots.jpg'],
        thumbnail: '/images/products/plant-pots.jpg',
        stock: 120,
        weightKg: 2.5,
        countryOfOrigin: 'China',
        isActive: true,
  ...
  products.push(
    await prisma.product.upsert({
      ...
      create: {
        ...
        costPrice: 7.00,
        images: ['/images/products/string-lights.jpg'],
        thumbnail: '/images/products/string-lights.jpg',
        stock: 250,
        weightKg: 0.4,
        countryOfOrigin: 'China',
        isActive: true,
  ...
  products.push(
    await prisma.product.upsert({
      ...
      create: {
        ...
        thumbnail: '/images/products/building-blocks.jpg',
        stock: 90,
        weightKg: 1.2,
        countryOfOrigin: 'China',
        isActive: true,
  ...
  products.push(
    await prisma.product.upsert({
      ...
      create: {
        ...
        thumbnail: '/images/products/power-bank.jpg',
        stock: 200,
        weightKg: 0.4,
        countryOfOrigin: 'China',
        isActive: true,
  ...
  products.push(
    await prisma.product.upsert({
      ...
      create: {
        ...
        thumbnail: '/images/products/winter-jacket.jpg',
        stock: 60,
        weightKg: 1.8,
        countryOfOrigin: 'China',
        isActive: true,
