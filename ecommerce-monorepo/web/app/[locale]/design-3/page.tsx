...
import { PHILIPS_PDP_PRODUCT } from './data/pdpData';
...
export default function App() {
  ...
  // Initial cart items setup matching ~128.50 BYN total from screenshot:
  // Lavazza (42.90) + Monini (28.70) + Ariel (49.90) + Ferrero Rocher (21.50) / etc.
  const [cartItems, setCartItems] = useState<CartItem[]>([
    { product: FLASH_DEALS[0], quantity: 1 }, // 42.90
    { product: FLASH_DEALS[1], quantity: 1 }, // 28.70
    { product: FLASH_DEALS[2], quantity: 1 }, // 49.90
    { product: FLASH_DEALS[5], quantity: 1 }, // 21.50
    // Total: 143.00 with promo or customized
  ]);

  // Initial favorites set (contains 12 items as in screenshot)
    ...
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <CatalogModal
        ...
        onSelectDepartment={(deptName, subcategory) => {
          // If subcategory selected, filter by department and set search keyword for that subcategory
