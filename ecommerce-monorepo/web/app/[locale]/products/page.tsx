...
function ProductsPageContent() {
  ...
  // Translate the static filter configuration (names + option labels)
  ...
  const localizedFilterSections = filterSections.map((section) => ({
    ...section,
    name: tt(sectionNameKeys[section.id] || section.id),
    options: section.options?.map((opt) => ({
      ...opt,
      label: tt((optionLabelKeys[section.id] || {})[opt.value] || opt.label),
    })),
  }))
  ...
  const breadcrumbItems = [
    ...
    { name: t('breadcrumbShop'), href: '/products' },
  ]
  ...
  const pageDescription = searchQuery 
    ? t('pageDescSearch', { n: totalProducts })
    : categorySlug
    ? t('pageDescCategory', { name: getCategoryName().toLowerCase() })
    : t('pageDescDefault')
        ...
        <Container maxWidth="2xl">
          ...
          <div className="flex flex-col md:flex-row gap-6 mt-6">
            ...
            <div className="hidden md:block w-64 flex-shrink-0">
              <FilterSidebar
                filters={localizedFilterSections}
