          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-2">
                <label className="flex items-start gap-2 text-sm text-gray-600">
                  ...
                  <span>
                    I agree to the{' '}
                    <LocaleLink href="/terms" className="text-[#1a3a5c] hover:underline">
                      Terms of Service
                    </LocaleLink>
                    {' '}and{' '}
                    <LocaleLink href="/privacy" className="text-[#1a3a5c] hover:underline">
                      Privacy Policy
                    </LocaleLink>
                  </span>
                </label>
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600">
                ...
                <LocaleLink href="/login" className="font-medium text-[#1a3a5c] hover:underline">
                  Sign in
                </LocaleLink>
              </p>
            </div>
